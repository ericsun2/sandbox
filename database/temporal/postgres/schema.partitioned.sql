...
COMMENT ON COLUMN executions.run_id is '== tree_id in history_node';
 360 changes: 360 additions & 0 deletions360  
...
v1.26/Dockerfile
Viewed
@@ -75,3 +75,7 @@ WORKDIR $TEMPORAL_HOME
EXPOSE 6933 6934 6935 6939 7233 7234 7235 7239

RUN cp -R /go/src/github.com/temporalio/temporal/schema /temporal/schema

# Override the Postgres DDL with partitioning
COPY postgresql.schema-partitioned.sql /temporal/schema/postgresql/v12/temporal/schema.sql

 384 changes: 384 additions & 0 deletions384  
v1.26/postgresql.schema-partitioned.sql
Viewed
@@ -0,0 +1,384 @@
CREATE TABLE namespaces(
  partition_id INTEGER NOT NULL,
